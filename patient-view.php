      ...
      <div class="card-body">
        <form class="form-group" method="post">
          <div class="row">
                  ...
                  <div class="col-md-8"><u><?php echo "$password"; ?></u></div><br><br>
                  <div class="col-md-4"><label>Address:</label></div>
                  <div class="col-md-8"><u><?php echo "$paddress"; ?></u></div><br><br>
          </div>
        </form>
        <?php
          echo "<a href = patient-edit?pid={$row["pid"]}><button  class='btn btn-success'>Edit</button></a>";
        ?>
        <a href="admin-panel1" class="btn btn-warning">Back</a>
      </div>
    </div>
