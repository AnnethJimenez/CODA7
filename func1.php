...
if(isset($_POST['docsub1'])){
	...
	$query="SELECT * from doctb where username='$dname' and password='$dpass' and status = 'Approved' ;";
    ...
    while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
          ...
          $_SESSION['docFees'] = $row['docFees'];
          $_SESSION['spec'] = $row['spec'];
          $_SESSION['id'] = $row['id'];  
          $_SESSION['descrip'] = $row['descrip']; 
          $_SESSION['haddress'] = $row['haddress']; 
          $_SESSION['status'] = $row['status'];
          $_SESSION['htype'] = $row['htype'];
