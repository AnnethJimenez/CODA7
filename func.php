...
if(isset($_POST['patsub'])){
	...
	$query="select * from patreg where email='$email' and password='$password' and status = 'Approved';";
    ...
    echo("<script>alert('Invalid Username or Password or not yet approved by admin. Please contact the admin. ');
