...
if(isset($_GET['update']))
  {
    $query2=mysqli_query($con,"update appointmenttb set doctorStatus='1' where id = '".$_GET['id']."'");
    if($query2)
    {
      echo "<script>alert('Your appointment successfully updated');</script>";
    }
  }
  ...
  <div class="col-md-8" style="margin-top: 3%;">
    ...
    <div class="tab-pane fade" id="list-app" role="tabpanel" aria-labelledby="list-home-list">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "SELECT pid,ID,fname,lname,gender,email,contact,appdate,apptime,userStatus,doctorStatus,adminStatus FROM appointmenttb WHERE doctor='$dname';";
             ...
             <a href="doctor-panel.php?id=<?php echo $row['ID']?>&update=update" 
              ...
              title="Update Appointment" tooltip-placement="top" tooltip="Remove"><button class="btn btn-success">Approve</button>              
            </a>
            <td>
