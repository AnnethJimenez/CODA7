            ...
            <div class="card-body">
              ...
              <form class="form-group" method="POST" action="func1.php">
                <div class="row" style="margin-top: 10%">
                  ...
                  <div class="col-md-8"><input type="text" name="username3" class="form-control" placeholder="Username" required/></div><br><br>
                  <div class="col-md-4" style="margin-top: 8%"><label>Password: </label></div>
                  <div class="col-md-8" style="margin-top: 8%"><input type="password" class="form-control" name="password3" placeholder="Password" required/></div><br><br><br>
                </div>
                <div class="row">
                 <div class="col-md-4"  style="padding-left: 170px;margin-top: 10%">
                    <center><input type="submit" id="inputbtn" name="docsub1" value="Login" class="btn btn-success"></center></div>           
