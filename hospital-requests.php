...
if(isset($_GET['update']))
  {
    $query2=mysqli_query($con,"UPDATE doctb set status = 'Approved' where id = '".$_GET['id']."'");
    if($query2)
    {
                ...
                'columns': [
                    ...
                    { 
                     ...
                     "render": function(data, type, row, meta)
                     {
                        if(type === 'display')
                        {
                            data = '<a href="patient-requests.php?id=<?php echo $row['id']?>&cancel=update"onClick="return confirm('Are you sure you want to cancel this appointment?')" title="Cancel Appointment" tooltip-placement="top" tooltip="Remove"><button class="btn btn-danger">Cancel</button></a>';                    
                        }
                        return data;
                     }
                    },
