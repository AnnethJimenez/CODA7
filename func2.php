...
if(isset($_POST['patsub1'])){
  ...
  if($password==$cpassword){
  	$query="INSERT into patreg(pid,fname,lname,gender,email,contact,password,cpassword,paddress,status) values ('P0002022$pid','$fname','$lname','$gender','$email','$contact','$password','$cpassword','$paddress','Pending');";
    ...
    if($result){
        ...
        echo "<script>alert('New Patient registered');</script>";
